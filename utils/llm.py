    ...
    def get_res(self):
        ...
        for batch in tqdm(self.dataloader):
            ...
            outs = self.model.generate(input_ids, attention_mask=attn_mask, max_new_tokens=self.args.max_new_tokens, 
                                       output_attentions=self.args.attn_weights, return_dict_in_generate=True, output_scores=True, output_hidden_states=self.args.hidden_states, top_p=1.0, temperature=self.args.temperature, do_sample=self.args.sampling)
